...
<div class="page-inner">
  <div class="page-header">
		<h4 class="page-title">Penimbangan Posyandu</h4>
      ...
      <div class="card">
        <div class="card-header">
          <div class="d-flex align-items-center">
            <h4 class="card-title">Data Penimbangan Posyandu</h4>
          </div>
				</div>
				<div class="card-body">
              ...
              <tbody>
                ...
                ?>
                  <tr>
                    ...
                    <td> <?php $status = $posyandu->getStatusPenimbangan($data_pendaftaran_posyandu['id_posyandu']); echo $status[1] ?> </td>
                    <td>
                      <a href="?p=timbang&id_posyandu=<?php echo $data_pendaftaran_posyandu['id_posyandu'] ?>" class="btn btn-primary btn-round btn-sm"> <i class="fas fa-edit mr-2"></i> Timbang</a>
                    </td>
                  </tr>
                <?php
                    }
