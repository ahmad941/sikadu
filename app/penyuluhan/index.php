...
<div class="page-inner">
  <div class="page-header">
		<h4 class="page-title">Penyuluhan Posyandu</h4>
      ...
      <div class="card">
        <div class="card-header">
          <div class="d-flex align-items-center">
            <h4 class="card-title">Data Penyuluhan Posyandu</h4>
          </div>
				</div>
				<div class="card-body">
              ...
              <tbody>
                ...
                ?>
                  <tr>
                    ...
                    <td> <?php echo $posyandu->getStatusPenyuluhan($data_pendaftaran_posyandu['id_posyandu']) ?> </td>
                    <td>
                      <a href="?p=penyuluhan&id_posyandu=<?php echo $data_pendaftaran_posyandu['id_posyandu'] ?>" class="btn btn-primary btn-round btn-sm"> <i class="fas fa-edit mr-2"></i> Penyuluhan</a>
                    </td>
                  </tr>
                <?php
                    }
